      ...
      <motion.div className="max-w-4xl mx-auto" variants={containerVariants} initial="hidden" animate="visible">
        ...
        <motion.div className=" shadow-lg rounded-lg overflow-hidden mb-12" variants={itemVariants}>
          <div className="px-6 py-8">
            ...
            <h2 className="text-2xl font-semibold text-blue-700 mb-4">Our Values</h2>
        ...
        <motion.h2 className="text-3xl text-center font-bold text-blue-800 mb-6" variants={itemVariants}>
          Our Adventures
        </motion.h2>
        <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" variants={containerVariants}>
          {photos.map((photo, index) => (
            ...
            >
              ...
              />
              <p className="text-center py-2 text-sm text-gray-600">{photo.alt}</p>
            </motion.div>
          ))}
        </motion.div>
      </motion.div>
